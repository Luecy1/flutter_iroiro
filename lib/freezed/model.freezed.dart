    ...
    return _then(_value.copyWith(
      ...
      age: age == freezed
          ...
          : age // ignore: cast_nullable_to_non_nullable
              as int,
      hosoku: hosoku == freezed
          ? _value.hosoku
          : hosoku // ignore: cast_nullable_to_non_nullable
              as String?,
    ));
  }
}
...
class _$_Person with DiagnosticableTreeMixin implements _Person {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Person(firstName: $firstName, lastName: $lastName, age: $age, hosoku: $hosoku)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('hosoku', hosoku));
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.hosoku, hosoku));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(hosoku));
